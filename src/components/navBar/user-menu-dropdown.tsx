            ...
            >
                ...
                >
                    {isDisconnected
                        ...
                        : renderDropdownItems(loggedInItems)}
                </DropdownSection>
                <DropdownSection classNames={{ base: "mb-0", divider: "mt-0" }}>
                    <DropdownItem
                        className={`flex items-center space-x-2 data-[hover=true]:bg-danger-400 hover:text-accent-foreground rounded-md p-2 my-2 transition-colors ${
